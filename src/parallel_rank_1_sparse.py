...
def process_rank_1_batch(l_values, k0, sorted_idx, Q, roots, K, batch_id):
    ...
    Q is expected to be SciPy sparse (CSC/CSR). (Also works if dense, but main will sparse it.)
    """
    ...
    for l in l_values:
        ...
        # sparse quadratic form: z*Qz = <z, Qz>
        Qz = Q @ z
...
def main():
    ...
    Q.sort_indices()
    Q.eliminate_zeros()
    log.info(f"Converted Q to sparse CSC: shape={Q.shape}, nnz={Q.nnz}")
