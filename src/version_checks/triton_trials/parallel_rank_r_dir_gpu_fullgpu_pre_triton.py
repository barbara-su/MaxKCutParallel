"""Historical full-GPU solver snapshot from before Triton quantization integration.

This preserves the pure PyTorch quantization/scoring path so it can be compared with
later Triton-enabled versions. It is archived for reference, not active development.
"""
