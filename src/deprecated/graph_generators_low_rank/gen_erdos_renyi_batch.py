...
def main():
    parser = argparse.ArgumentParser(
        description="Generate multiple Erdos-Renyi graphs and low-rank eigenvector matrices."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--out_dir", type=str, default="graphs_er",
    ...
    for seed in range(num_seeds):
        print(f"Generating ER graph with n={n}, p={p}, seed={seed}, rank={r}")
