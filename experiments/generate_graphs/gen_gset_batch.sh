...
# to call it
# sbatch experiments/generate_graphs/gen_gset_batch.sh 1 42 false 0 0 gset graphs/gset_rank_1 81 true
# sbatch experiments/generate_graphs/gen_gset_batch.sh 2 42 false 0 0 gset graphs/gset_rank_2 81 true